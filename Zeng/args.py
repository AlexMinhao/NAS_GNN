...
def get_citation_args():
    ...
    parser.add_argument('--dataset', type=str, default="citeseer",
                        help='Dataset to use.')
    parser.add_argument('--model', type=str, default="Low",
                        choices=["SGC", "GCN", "Low"],
                        help='model to use.')
    ...
    parser.add_argument('--L', type=int, default=4,
                        help='degree of features without dimension reduction.')
    parser.add_argument('--K', type=int, default=8,
                        help='degree of furthest distance.')
    parser.add_argument('--decay', type=float, default=1,
                        help='Relative low dimension decay rate.')
